...
locals {
  network_compartment_name = "${lower(var.realm)}_${lower(var.service_identifier)}_${lower(var.stack_name)}_network"
  ...
  p2t_compartment_name = "${lower(var.realm)}_${lower(var.service_identifier)}_${lower(var.stack_name)}_p2t"
}
