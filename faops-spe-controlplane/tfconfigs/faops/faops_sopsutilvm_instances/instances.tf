module "faops_sopsutilvm_instances" {
  source = "../../../tfmodules/faops/faops_sopsutilvm_instances"
  # region = "${var.region}"
  region = "${var.faops_sopsutilvm_region != "" ? var.faops_sopsutilvm_region : local.faops_sopsutilvm_region_map[var.realm]}"
...
//LB
  ...
  faops_sopsutilvm_8203_health_checker_url = "${var.faops_sopsutilvm_8203_health_checker_url}"
  faops_sopsutilvm_8080_health_checker_url = "${var.faops_sopsutilvm_8080_health_checker_url}"
  ...
  management_load_balancer_shape = "${var.faops_sopsutilvm_lb_shape}"
...
# 
  ...
  faops_sopsutilvm_ad_indices = ["${split(",", length(var.faops_sopsutilvm_ad_indices) == 0 ? join(",", local.faops_sopsutilvm_ad_indices_map[var.realm]) : join(",", var.faops_sopsutilvm_ad_indices))}"]
  ...
  faops_sopsutilvm_local_volume_size_in_gbs = "${var.faops_sopsutilvm_local_volume_size_in_gbs != "" ? var.faops_sopsutilvm_local_volume_size_in_gbs :  local.volume_size_in_gbs_map[var.realm]}"
  ...
  // Hostname
  faops_sopsutilvm_inv_hostname = "${var.faops_sopsutilvm_inv_hostname}"
  faops_sopsutilvm_jenkins_hostname = "${var.faops_sopsutilvm_jenkins_hostname}"
}

output "FAOPS SOPS VM IP Address" {
  value = "${module.faops_sopsutilvm_instances.faops_sopsutilvm}"
}


output "FAOPS SOPS LB Public IP Address" {
  value = "${module.faops_sopsutilvm_instances.management_load_balancer_public_ip_address}"
}
