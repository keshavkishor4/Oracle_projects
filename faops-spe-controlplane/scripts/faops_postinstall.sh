...
sudo firewall-offline-cmd --add-port=8023/tcp
sudo firewall-offline-cmd --add-port=8022/tcp
...
sudo yum -y install python3 python3-pip python-oci-sdk python-oci-cli