...
function start_data_clean(){
    ...
    LOG_FILE="${LOG_DIR}/mining_data_cleaning_logs_${end_date}_${DATE}.log"
    /usr/bin/script -f $LOG_FILE /bin/bash -c "${proj_path}/full_dart_scraping/json_data_clean.py $*"
