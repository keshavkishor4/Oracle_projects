...
download(){
    # data=`oci os object list -bn $source_bucket -ns $source_ns --auth instance_principal --prefix fa  --region us-ashburn-1 | jq -r '.data[] .name'`
    FILE_NAME="fa_vpn_daily_extract_${dt_time}.json"
