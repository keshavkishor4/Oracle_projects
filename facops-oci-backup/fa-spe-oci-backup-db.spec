...
%define     PNAME fa-peo-oci-backup
Name:		%PNAME
Version:	2.0.0.0
Release:	200120
...
cp -a src/mt/conf/* $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/config/mt/
cp -r src/mt/conf/ $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/config/mt/
cp -a src/db $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/utils/
#Setup for v2
cp -a src/mt/conf/backup_config/* $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/config/mt/backup_config
cp -a src/db/conf/housekeeping-db_v2.json $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/config/db/housekeeping-db_v2.json
cp -a src/common/conf/faops-backup-ver.json $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/config/faops-backup-ver.json

cp -a src/common/key_archive/oci_api_key.pem $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/config/key_archive/
cp -a src/common/key_archive/oci_api_key_public.pem $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/config/key_archive/
cp -a src/common/key_archive/oci_api_key.pem $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/config/mt/
cp -a src/common/oci_curl.sh $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/utils/
cp -a src/common/oci_setup.sh $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/utils/
cp -a src/mt/ocifsbackup.py $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/bin/
cp -a src/wallet/db_wallet_backup.py $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/bin/
cp -a src/wallet/db_artifacts_backup.py $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/bin/
cp -a src/db/rman_wrapper.py $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/bin/
cp -a src/db/rman_oss.py $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/bin/
#Setup for v2
cp -a src/dbtasks/db_tasks.py $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/bin/
cp -a src/wallet/db_download_obj.py $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/bin/
...
rm -f $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/utils/db/conf/.passwd.json
rm -f $RPM_BUILD_ROOT/opt/faops/spe/ocifabackup/utils/db/conf/housekeeping-db_v2.json
...
%attr(0755,root,root) /opt/faops/spe/ocifabackup/bin/rman_wrapper.py
%attr(0755,root,root) /opt/faops/spe/ocifabackup/bin/rman_oss.py
...
%config(noreplace) %attr(644,oracle,root) /opt/faops/spe/ocifabackup/config/faops-backup-ver.json

%config(noreplace) %attr(644,oracle,root) /opt/faops/spe/ocifabackup/utils/db/Readme_all_pod_info.txt
%config(noreplace) %attr(644,oracle,root) /opt/faops/spe/ocifabackup/utils/db/all-pod-info_saasfapre-8wjxg1.txt
%config(noreplace) %attr(644,oracle,root) /opt/faops/spe/ocifabackup/utils/db/all-pod-schedule.txt
%config(noreplace) %attr(644,oracle,root) /opt/faops/spe/ocifabackup/utils/db/backup_schedule.txt
%config(noreplace) %attr(644,oracle,root) /opt/faops/spe/ocifabackup/utils/db/database.txt
%config(noreplace) %attr(644,oracle,root) /opt/faops/spe/ocifabackup/utils/db/database_config_schedule.txt
