...
class region_level_capacity_list(admin.ModelAdmin):
    list_display = ('region_name','free_count','availability_domain','display_name','cap_id','reserved_instance_count','used_instance_count','percentage')

class region_level_capacity_list_monitoring(admin.ModelAdmin):
    list_display = ('region_name','free_count','availability_domain','display_name','cap_id','reserved_instance_count','used_instance_count','percentage','dtime')
...
class capacity_reservation_level_capacity_details_data(admin.ModelAdmin):
    list_display = ('region_name','free_count','availability_domain','cap_id','display_name','instance_shape','reserved_count','used_count','memory','ocpus','percentage')

class capacity_reservation_level_capacity_details_data_monitoring(admin.ModelAdmin):
    list_display = ('region_name','free_count','availability_domain','cap_id','display_name','instance_shape','reserved_count','used_count','memory','ocpus','percentage','dtime')
...
class cap_data_admin(admin.ModelAdmin):
    list_display = ('Pod_Name','region_name','availability_domain','display_name','cap_id','reserved_instance_count','used_instance_count','percentage','free_count')

class cap_data_admin_monitoring(admin.ModelAdmin):
    list_display = ('Pod_Name','region_name','availability_domain','display_name','cap_id','reserved_instance_count','used_instance_count','percentage','dtime','free_count')

class pod_cap_data_admin(admin.ModelAdmin):
    list_display = ('region_name','free_count','availability_domain','cap_id','display_name','instance_shape','reserved_count','used_count','memory','ocpus','percentage')

class pod_cap_data_admin_monitoring(admin.ModelAdmin):
    list_display = ('region_name','free_count','cap_id','display_name','instance_shape','reserved_count','used_count','memory','ocpus','percentage','dtime')

class exa_data_info_admin(admin.ModelAdmin):
    list_display = ('exa_node','Pod_Name','Shape')

class exa_data_info_monitoring_admin(admin.ModelAdmin):
    list_display = ('exa_node','Pod_Name','Shape','dtime')
