        ...
        try:
            ...
            if not self.check_file_age(manual_pod_json_file, timedelta):
                if os.path.exists(globalvariables.raw_psr):
                    ...
                    #print(manual_pod_url_result)
                    stamp_pod_content = ast.literal_eval(manual_pod_url_result.text)
                    ...
                    with open(manual_pod_json_file, 'w') as jd:
                        # Use json.dumps to properly serialize the data
        ...
        try:
            ...
            if not self.check_file_age(stamp_pod_json_file,timedelta):
                if os.path.exists(globalvariables.raw_psr):
                    ...
                    stamp_pod_content = ast.literal_eval(stamp_pod_url_result.text)
