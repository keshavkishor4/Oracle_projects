...
function install_python() {
    export C_INCLUDE_PATH=/opt/faops/spe/fliprt/utils/sqllite/include
    export CPLUS_INCLUDE_PATH=/opt/faops/spe/fliprt/utils/sqllite/include 
    export LD_RUN_PATH=/opt/faops/spe/fliprt/utils/sqllite/lib
    export PATH=$SSL_INSTALL_DIR/bin:$PATH
    export LD_LIBRARY_PATH=$SSL_INSTALL_DIR/lib:/opt/faops/spe/fliprt/utils/sqllite/lib
    export LDFLAGS="-L${LD_LIBRARY_PATH} -Wl,-rpath,${LD_LIBRARY_PATH}"
...
function sqllite(){
    mkdir -p /opt/faops/spe/fliprt/utils/sqllite
    export sqlite="/opt/faops/spe/fliprt/utils/sqllite"
    curl -L -o /opt/faops/spe/fliprt/utils/sqllite/sqlite-autoconf-3410200.tar.gz https://www.sqlite.org/2023/sqlite-autoconf-3410200.tar.gz
    cd /opt/faops/spe/fliprt/utils/sqllite/
